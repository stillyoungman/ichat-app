...
class ConversationsProvider {
    public static let instance = ConversationsProvider()
...
extension ConversationsProvider: IConversationsProvider {
    typealias ConversationsCollection = Conversations
    
    func conversations(for type: ConversationType) -> Conversations {
        switch type {
